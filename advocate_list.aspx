<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="advocate_list.aspx.cs" Inherits="userlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [userID], [emailID], [fname], [lname], [gender], [father_Name], [dob], [address], [city], [state], [postal_Code], [country], [phone_no], [rdate],[image] FROM [advocate] WHERE ([utype] = @utype)">
        <SelectParameters>
            <asp:Parameter DefaultValue="Advocate" Name="utype" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
        </div>
</center>
